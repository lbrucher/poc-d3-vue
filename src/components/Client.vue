...
<template>
  <div class="client row g-0">
    ...
    <div class="col accounts">
      <div v-if="accountsToShow.length > 0" class="account-details" @click="showAccountDetails()">Account Details...</div>
      <AccountsChart :client="client" :cardTypes="cardTypes" :chartData="chartData" :accounts="accountsToShow" @click="onChartClicked" />
    </div>
  </div>
</template>
